...
{                  
        ...
        <Modal show={show} onHide={handleClose}>
          ...
          <Modal.Body>
            ...
            <iframe width={"100%"} height={"400px"} src={`${card?.url}?autoplay=1`} title="Thor vs Hulk - Fight Scene - The Avengers (2012) Movie Clip HD" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
