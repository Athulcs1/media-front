...
// function define for get a video from back end
...
export  const deletecategory=async(id)=>{
  return  await commonRequest("GET",`${BASE_URL}/category/${id}`,{});
}
...
// to get a specific video data from resouce
...
export const updateCategory=async(id, boby)=>{
  return await commonRequest("PUT",`${BASE_URL}/category/${id}`,boby)
}